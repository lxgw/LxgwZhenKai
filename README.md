> **鉴于有用户认为该字体仍然细，本字体可能将面临重新调整。本来这款字体是为了制作更粗字重的字体，结果在字重的选择上还是过于保守……**
> 
> 这款字体在细节调整上花费了我很多时间和精力，结果通过一些人的反馈，预期目标还是没有达到。
> 要么我改变策略，细节什么的都不考虑，直接机械加粗 *（这么做有点背离臻楷「减少模糊粘连」的初衷，但是 GB 2312 范围内的低频字都是直接机械加粗的，或许是没有耐心再做细节调整了）* ；要么就只能放弃了，毕竟我的业余时间、精力和能力都非常有限，难以满足一些用户的需求。😭
> 
> 如果您觉得这款字体仍然细，请转用酷安用户 [@说到底](http://www.coolapk.com/u/725698) 制作的 [加粗版文楷](https://www.coolapk.com/feed/36436823?shareKey=MzFjYzJkNzdkYTNhNjI5YWZjN2Q~&shareUid=633884&shareFrom=com.coolapk.market_12.3)。本项目将不再更新，并归档处理。感谢大家的反馈。
