...
4. 自 [v0.800.2](https://github.com/lxgw/LxgwZhenKai/releases/tag/v0.800.2) 之后，只维护 GB 字形版，无后缀版《霞鹜臻楷》不再更新维护。另提供 Windows 内置「楷体」度量兼容版本「臻楷_GBK」，采用 GBK 字符集、GungsuhChe 等宽西文（该版本随时取消）。
